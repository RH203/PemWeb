...
if (isset($_POST["submit"])) {
  ...
  if ($error_message === "") {
    ...
    $birth_month = mysqli_real_escape_string($conn, $birth_month);
    $birth_year = mysqli_real_escape_string($conn, $birth_year);
    $gpa = (float) $gpa;
    ...
    <form id="form_mahasiswa" action="tambah_mahasiswa.php" method="post">
      <fieldset>
        ...
        <p>
          ...
          <input type="text" name="nim" id="nim" value="<?php echo $nim ?>" placeholder="Contoh: 12345678"> (8 digit
          angka)
        </p>
        <p>
        ...
        <p>
          ...
          <input type="text" name="gpa" id="gpa" value="<?php echo $gpa ?>" placeholder="Contoh: 2.75"> (angka desimal
          dipisah dengan karakter titik ".")
        </p>
      </fieldset>
      <br>
      <p>
